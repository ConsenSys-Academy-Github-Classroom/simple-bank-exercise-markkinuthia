...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender], string(abi.encodePacked("User should be enrolled before they can make deposit")));
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
     ...
     require(withdrawAmount <= balances[msg.sender], "sender has insuffient funds");
